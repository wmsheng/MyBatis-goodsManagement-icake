...
(function (a, b) {
    ...
    a.effects.animateClass = function (b, c, d, e) {
        ...
        version: "1.8.18", save: function (a, b) {
            ...
            b.wrap(d), (b[0] === e || a.contains(b[0], e)) && a(e).focus(), d = b.parent(), b.css("position") == "static" ? (d.css({position: "relative"}), b.css({position: "relative"})) : (a.extend(c, {
        ...
        version: "1.8.18", animations: {
            slide: function (b, c) {
                ...
                if (!b.toHide.size()) b.toShow.animate({
                    ...
                    var d = b.toShow.css("overflow"), e = 0, f = {}, g = {},
                        h = ["height", "paddingTop", "paddingBottom"], i, j = b.toShow;
